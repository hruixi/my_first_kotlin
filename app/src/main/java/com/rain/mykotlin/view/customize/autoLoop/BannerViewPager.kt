...
class BannerViewPager<T> : RelativeLayout, LifecycleObserver {
    ...
    private fun setupViewPager(list: List<T>) {
        if (mBannerPagerAdapter == null) {
            throw NullPointerException("You must set adapter for com.rain.mykotlin.view.customize.autoLoop.BannerViewPager")
        }
    ...
    /**
     * 使用数据创建 com.rain.mykotlin.view.customize.autoLoop.BannerViewPager
     */
